...
int main(void)
{
    ...
    printf("    SC0CLK (PC.1) <--> card slot clock pin\n");
    printf("    SC0DAT (PC.0) <--> card slot data pin\n");
    printf("    SC0PWR (PC.3) <--> card slot power pin\n");
    printf("    SC0RST (PC.2) <--> card slot reset pin\n");
